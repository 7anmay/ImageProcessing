...
while True:
    ...
    lower_blue = np.array([92, 110, 161])
    upper_blue = np.array([132, 214, 255])

    lower_pink = np.array([148, 112, 154])
    upper_pink = np.array([185, 185, 255])
    ...
    if(len(area_pink)>0):
        ...
        #rame = cv2.drawContours(frame, [box_pink_1], 0, (0, 255, 255), 2)
