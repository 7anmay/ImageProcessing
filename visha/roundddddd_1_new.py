...
for i in goal:
    ...
    while True:
        ...
        cv2.line(fortress, (cent[0][0],cent[0][1]), (i[0],i[1]), (0, 255, 255), 2)
        cv2.imshow('fortress', fortress)
        cv2.waitKey(1)
        ...
        while(math.fabs(ang)<=40):
            ...
            if dir == 'anticlockwise':
                dir = 'p'
            cv2.line(fortress, (cent_pink[0], cent_pink[1]), (cent_blue[0], cent_blue[1]), (0, 255, 255), 2)
            cv2.line(fortress, (cent[0], cent[1]), (i[0], i[1]), (0, 255, 255), 2)
            print 'dis =', dis
            print 'direction = ', dir
            cv2.imshow('fortress',fortress)
            cv2.waitKey(1)
