...
def marker_loc():
    ...
    while True:
        ...
        lower_blue = np.array([86, 161, 127])
        upper_blue = np.array([125, 255, 255])

        lower_pink = np.array([120, 47, 141])
        upper_pink = np.array([175, 156, 190])
...
color = [(255,255,1),(0,0,254),(1,255,1),(254,0,0),(248,8,245)]
print 1
...
ret,thresh_arena = cv2.threshold(arena_gray,168,255,cv2.THRESH_BINARY)
...
print len(finalsequence)

goal = np.zeros((6,2),np.uint32)
...
for i in range(len(finalsequence)):
    cv2.circle(arena,(goal[i][0],goal[i][1]),0,(255,255,255),thickness = 2)
