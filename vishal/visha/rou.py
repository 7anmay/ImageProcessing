...
def angle(cent_1,cent_2,goal1):
    ...
    if (int(cent_1[0][0] - cent_2[0][0]) == 0 and not(int((cent_1[0][0] + cent_2[0][0]) / float(2)) - goal1[0]) == 0):
    ...
    elif(int(((cent_1[0][0] + cent_2[0][0]) / float(2)) - goal1[0]) == 0 and not((cent_1[0][0] - cent_2[0][0]) == 0)):
    ...
    elif(int(cent_1[0][0] - cent_2[0][0]) == 0 and int(((cent_1[0][0] + cent_2[0][0]) / float(2)) - goal1[0]) == 0):
        if (dis1<dis2):
            angle = 1
        else:
            angle = 180
        ...
        if(ang1<0 and ang2>0):
            print 'condition1'
            angle = (math.fabs(ang1) - (180 - math.fabs(ang2)))
            if(dis1 > dis2):
                print 'condition1-2'
                angle = (180 - math.fabs(angle))*(-1)
        elif (ang1 > 0 and ang2 < 0):
            print 'condition2'
            angle = (180-((math.fabs(ang1) - (180 - math.fabs(ang2)))*(-1)))
            if (dis1 > dis2):
                print 'condition2-1'
                angle = (math.fabs(angle)-180)
        else:
            print 'condition3'
            ...
            if (dis1 >= dis2):
                print 'condition3-1'
                if (angle > 0):
                    print 'condition3-1-1'
                    angle = (180 - angle) * (-1)
                elif (angle <= 0):
                    print 'condition3-1-2'
                    angle = (math.fabs(angle) - 180) * (-1)
    return angle

def direction(angle,goal1,cent_1,cent_2):

    if ((not(cent_1[0][0] - cent_2[0][0]) == 0) and (int((cent_1[0][0] + cent_2[0][0]) / float(2)) - goal1[0]) == 0):
        if angle<0:
            dir = 'anticlockwise'
        else:
            dir = 'clockwise'
...
for i in goal:
    ...
    while(True):
        ...
        dir = direction(ang,i,cent_pink,cent_blue)
