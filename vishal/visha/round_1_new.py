...
def centroid(cent_pink,cent_blue):
    x =cent_pink[0][0]+cent_blue[0][0]/2
    y =cent_pink[0][1]+cent_blue[0][1]/2
    cent[0][0]=x
    cent[0][1]=y
...
def angle(cent_pink,cent_blue,goal1):
    ...
    if ((cent_pink[0][0] - cent_blue[0][0]) == 0 and not(int((cent_pink[0][0] + cent_blue[0][0]) / float(2)) - goal1[0]) == 0):
        m2 = (((cent_pink[0][1] + cent_blue[0][1]) / float(2)) - goal1[1]) / float(((cent_pink[0][0] + cent_blue[0][0]) / float(2)) - goal1[0])
    ...
    elif(int(((cent_pink[0][0] + cent_blue[0][0]) / float(2)) - goal1[0]) == 0 and not((cent_pink[0][0] - cent_blue[0][0]) == 0)):
    ...
    elif(int(cent_pink[0][0] - cent_blue[0][0]) == 0 and int(((cent_pink[0][0] + cent_blue[0][0]) / float(2)) - goal[0]) == 0):
        if (dis1<dis2):
            angle = 1
        else:
            angle = 180
...
def direction(angle):
    ...
    if ((cent_pink[0][0] - cent_blue[0][0]) == 0 and (int((cent_pink[0][0] + cent_blue[0][0]) / float(2)) - goal1[0]) == 0):
        if angle<0:
            dir = 'anticlockwise'
        else:
            dir = 'clockwise'
...
for i in goal:
    ...
    while(True):
        ...
        #cv2.line(check, (goal[0],goal[1]), (cent[0][0], cent[0][1]), (255, 255, 255), thickness=3)
        print ang , dir
        if (dir == 'clockwise'):
            dir = 'c'
        else:
        ...
        if (dist<20):
            ...
            t = 1
            break
        #cv2.line(frame,cent,i,(255,0,255),2)
        #cv2.line(frame,cent_blue,cent_pink,(o,233,233),2)
        if (t==1):
            blink = blink + 1
            continue
